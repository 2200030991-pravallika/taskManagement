...
export function loadMenu(res)
{
    ...
    {
        list += `<li>
                    <label id='${data[x].mid}L'>${data[x].mtit}</label>
    ...
    for(x in data)
    {
        // L is used for the concatenation
...
export function loadModule(smid)
{
    ...
    switch (smid) 
    {
        ...
        case "M00101":
             ...
             module.src='/addyourtask';
             titlebar.innerText="Add Your Task";
             break;

        case "M00102":

             module.src='/viewyourtasks';
             titlebar.innerText="View YourTask";
             break;     
        default:
            module.src="";
            titlebar.innerText="";
        ...
        return(
            <div className='fullheight'>
                <div className='header'>
                    <label style={titlestyle}>TASK MANAGEMENT SYSTEM</label>
