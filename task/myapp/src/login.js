...
import logo from './images/loginlogo1.jpg'
...
function Login(){
    ...
    return(
        <div className='fullheight'>
            <div id='loginheader' className='loginheader'>WELCOME TO TASK MANAGEMENT WEBSITE</div>
            <div id='logincontent'>
                <div id='login' className='popup'>
                    <div id='loginwindow' className='popupwindow' style={popupwindowstyle}>
                        ...
                        <div id='logininnerwindow' className='innerwindow'>
                            ...
                            <div style={space}></div>
                            <div> <button className='btn' onClick={validate} >Forgot Password</button> </div>
                            <div style={space}></div>
                            <div>New user? <button className='linklabel' onClick={registration} >Register</button></div>
                        </div>
                    </div>    
                </div>
